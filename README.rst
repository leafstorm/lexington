...
It's built on top of a regular expression implementation that allows for
easy introspection and composition, by building regular expressions out of
Python objects.

Oh, and it's named after Lexington, North Carolina, not any of the other
